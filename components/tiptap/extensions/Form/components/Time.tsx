...
import { FormAttributes, TimeForm } from "../types";
...
export default function Time({
  ...
  if (!form[tab] || form[tab].type !== "time") {
    return null;
  }

  const currentForm = form[tab] as TimeForm;
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='space-y-2'>
        <Label>Ответ</Label>
        <Input type='time' placeholder='Дата...' className='w-full' disabled />
      </div>
    </div>
  );
}
