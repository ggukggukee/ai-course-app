...
export const ImageUploader = ({
  ...
  // Create a wrapper function that converts File to ArrayBuffer before calling uploadFile
  ...
  const text = useMemo(() => {
    switch (extension) {
      case "carouselUpload":
        return "Загрузите для слайдера";
      case "doubleUpload":
        return "Загрузите для двойного изображения";
      case "fileUpload":
