...
declare module "@tiptap/core" {
  interface Commands<ReturnType> {
    youtube: {
      ...
      setYoutubeAlign: (align: "left" | "right" | "center") => ReturnType;
      setYoutubeWidth: (width: number) => ReturnType;
    };
  }
}
  ...
  addCommands() {
    return {
      ...
      setYoutubeAlign:
        (align) =>
        ({ commands }) =>
          commands.updateAttributes("youtube", { align }),

      setYoutubeWidth:
        (width) =>
        ({ commands }) =>
          commands.updateAttributes("youtube", {
